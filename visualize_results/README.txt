...
1. app.Rmd 
   ...
   Contains all code used to generate the Shiny App 
...
3. results 
   ...
   For a given scenario X (where X is an integer from 1-18) there are four files: 
...
4. rsconnect 
   ...
   A folder generated by R Shiny upon deployment of the app. 