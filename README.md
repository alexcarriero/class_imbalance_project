...
In this project, we investigated the effect of imbalance correction on the predictive performance of prediction models developed for dichotomous risk prediction. 
