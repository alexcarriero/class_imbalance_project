...
For a given scenario X (where X is an integer between 1 and 18), this function generates one file called scX_brier_scores.rds and stores it in the directory:  data_archive > results > simulation_results > raw_results > scX > HERE
...
# data_archive > visualize_results > results > HERE 
...
# and stored it in the directory:  data_archive > results > processed_results > plot_coords > raw_results > scX > HERE 
#
...
#    in the directory: data_archive > results > simulation_results > recalibrated_results > scX > predictions > HERE 
#
# 2. computes and saves the new empirical performance metrics in a file called "scX_Y.rds" 
#    in the directory: data_archive > results > simulation_results > recalibrated_results > scX > per_iter_results > HERE 
#
...
# and stored it in the directory:  data_archive > results > processed_results > plot_coords > recalibrated_results > scX > HERE 
#
...
# data_archive > manuscript > tables > HERE
